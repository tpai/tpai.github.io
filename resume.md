...
**OneDegree** 首席網站可靠性工程師 *2022.7-2025.3*
    ...
    ・將 Fortify 與 GitLab CI/CD Pipeline 整合以生成掃描報告。
    ・藉由 PoC <u>MLflow</u> Stack，協助 AI 團隊簡化模型訓練流程。
    ・協調跨部門的 SRE 資源以及工作項目安排。
**OneDegree** 資深網站可靠性工程師 *2021.7-2022.7*
    負責管理和自動化雲端基礎設施。
    ・維護 <u>Docker</u> 的虛擬機和 <u>Kubernetes</u> 集群。
    ・開發 <u>GitLab CI/CD</u> Pipeline 並且優化部署流程。
    ・整合 <u>Elastic Stack</u> 為應用程式收集日誌。
    ・導入 <u>Ansible</u> 和 <u>Terraform</u> 用於基礎設施建置。
    ・使用 <u>Prometheus</u> 和 <u>Grafana</u> 實施監控。
**OneDegree** 資深工程師 *2020.5-2021.7*
    基於 Scrum 敏捷開發流程交付保險核心系統。
    ・開發基於 <u>Next.js</u> 的 Server-Side Rendering 應用。
    ・打造工具協助前後端 Schema 對照。
    ・主持內部技術分享會。
...
* **Summary GPT Bot**
    ...
    整合 AI 的 Telegram 機器人，可以為大量文字、網址、PDF 和 YouTube 視頻生成簡潔的摘要。

* **Doge Deck**
    <u><a href="https://github.com/tpai/dogedeck" target="_blank">tpai/dogedeck</a></u>
    色色柴犬卡冊，收集了基於遊戲王卡面的各種色色柴犬，提供搜尋功能方便迷因圖戰。推出後一週內迅速爆紅，自推出以來已有 13 萬名不重複訪客。

* **Taiwan Travel Level**
    <u><a href="https://github.com/tpai/taiwan-travel-level" target="_blank">tpai/taiwan-travel-level</a></u>
    有一個工具叫做 <a href="https://uub.jp/kkn/" target="_blank">KKN</a>，它會根據你在日本停留的時間和地點生成地圖和分數，我做了一個台灣版，在兩週內吸引了 70 萬名不重複訪客。
